...
class TradeBot:
    ...
    def __init__(self, config: Config):
        ...
        self.prompts_select_token = {
            'sellall': 'Продать весь баланс какого токена?',
            'addorder': 'Добавить ордер для какого токена?',
            'removeorder': 'Удалить ордер для какого токена?',
            'buysell': 'Купить или продать сейчас какой токен?',
            'approve': 'Подтведить какой токен на PancakeSwap?',
            'address': 'Получить адрес для какого токена?',
            'edittoken': 'Правка иконки и проскальзывания для какого токена?',
            'removetoken': 'Какой токен вы хотите удалить?',
        }
    ...
    def setup_telegram(self):
        ...
        commands = [
            ('status', 'Показать все токены, их цену, ордера'),
            ('buysell', 'Купить или продать токен сейчас'),
            ('sellall', 'Продать весь баланс токена сейчас'),
            ('addorder', 'Добавить ордер для одного из токенов'),
            ('removeorder', 'Удалить ордер для одного из токенов'),
            ('addtoken', 'Добавить токен для торговли'),
            ('removetoken', 'Удалить токен который вы добавили'),
            ('edittoken', 'Правка эмодзи и проскальзывания для токена'),
            ('approve', 'Подтвердить токен для торговли на PancakeSwap'),
            ('order', 'Показать информацию по ордеру, передать ID ордера в качестве аргумента'),
